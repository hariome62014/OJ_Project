...
problemSchema.pre('save', function(next) {
  if (this.totalSubmissions > 0) {
    this.acceptance = Math.round((this.correctSubmissions / this.totalSubmissions) * 100);
  } else {
    this.acceptance = 0;
  }
  next();
...
// Add a method to update acceptance when submissions change
problemSchema.methods.updateAcceptance = async function() {
  if (this.totalSubmissions > 0) {
    this.acceptance = Math.round((this.correctSubmissions / this.totalSubmissions) * 100);
  } else {
    this.acceptance = 0;
